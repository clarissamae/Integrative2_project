...
<template>
  <div class="bg-gray-100 text-gray-800 antialiased">
    ...
    <div class="pt-16 max-w-7xl mx-auto flex flex-col lg:flex-row">
      ...
      >
        ...
        <div class="flex-1 flex flex-col">
          ...
          <div class="mt-4 bg-gray-50 border border-gray-50 rounded-md flex flex-col h-64">
            <div
    ...
    >
      <div class="bg-gray-100 px-4 py-3 flex items-center justify-between border-b border-gray-50">
